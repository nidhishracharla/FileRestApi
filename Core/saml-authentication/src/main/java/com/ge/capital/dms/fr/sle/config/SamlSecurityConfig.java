...
import com.ge.capital.dms.fr.sle.service.SamlUserDetailsServiceImpl;
...
public class SamlSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	public MetadataGenerator metadataGenerator() {
		 ...
		 */
		//metadataGenerator.setEntityId("gecap-commoncmsapp-dev");
		metadataGenerator.setEntityId("gecap-commoncmsui-dev");
		//metadataGenerator.setEntityBaseURL("http://g2422usdwgpa02v.logon.ds.ge.com:8080/api");
		metadataGenerator.setEntityBaseURL("http://g2422usdwgpa02v.logon.ds.ge.com:7070/angular-saml-client");
	...
	public Protocol socketFactoryProtocol() {
		return new Protocol("http", socketFactory(), 443);
	}
	...
	public SAMLContextProviderImpl contextProvider() {
		...
		samlContextProviderLB.setServerName("g2422usdwgpa02v.logon.ds.ge.com");
		samlContextProviderLB.setServerPort(7777);
		...
		//samlContextProviderLB.setContextPath("/api");
	...
	public ExtendedMetadataDelegate idpMetadata() throws MetadataProviderException, ResourceException {
		...
		ResourceBackedMetadataProvider resourceBackedMetadataProvider = new ResourceBackedMetadataProvider(
				backgroundTaskTimer, new ClasspathResource("/ssocircle-metadata.xml"));
